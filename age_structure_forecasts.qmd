...
Retirement data is sourced from the *Retirement and Retirement Intentions* dataset (Catalogue 6238) for the 2022--2023 financial year [@ABS6238]. The data are categorised by the industry of an individual's main job, and are provided in four broad age groups (45--59, 60--64, 65--69 and 70+). There are 19 industry categories, but the majority of scientists work in Education and Training, Professional, Scientific and Technical Services, and Health Care and Social Assistance, representing 15.8%, 15.5%, and 14.6%, respectively. The proportions in other industries are much smaller. We take a weighted average of retirement intentions using these top three industries, with proportions rescaled to sum to 1. The data are shown in @fig-retirements as the gray line. To obtain a single-year-or-age retirement distribution, we disaggregate the data using a monotonic cubic spline applied to the cumulative values of these age groups [@SHW04]. The resulting smoothed distribution is shown as the blue line in @fig-retirements.
