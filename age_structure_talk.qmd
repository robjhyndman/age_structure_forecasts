...
```{r}
#| label: labour-force-future0
tar_read(fig_Pxt0) + ggplot2::ylim(-1,21000)
```
...
```{r}
#| label: labour-force-future1
tar_read(fig_Pxt1) + ggplot2::ylim(-1,21000)
```
...
```{r}
#| label: labour-force-future2
tar_read(fig_Pxt2) + ggplot2::ylim(-1,21000)
```
